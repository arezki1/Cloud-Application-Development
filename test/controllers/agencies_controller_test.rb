...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { location: @agency.location, name: @agency.name } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { location: @agency.location, name: @agency.name } }
