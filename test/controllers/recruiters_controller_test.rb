...
class RecruitersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recruiter" do
    assert_difference('Recruiter.count') do
      post recruiters_url, params: { recruiter: { agency_id: @recruiter.agency_id, firstname: @recruiter.firstname, name: @recruiter.name } }
    end
  ...
  test "should update recruiter" do
    patch recruiter_url(@recruiter), params: { recruiter: { agency_id: @recruiter.agency_id, firstname: @recruiter.firstname, name: @recruiter.name } }
